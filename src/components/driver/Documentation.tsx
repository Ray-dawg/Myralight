...
export default function Documentation() {
  const sections = [
    ...
    },
    {
      ...
      icon: FileText,
      articles: [
        { title: "Finding Loads", link: "#loads" },
        { title: "Load Acceptance", link: "#acceptance" },
        { title: "Trip Planning", link: "#planning" },
      ],
    },
    {
      title: "App Features",
      icon: Code,
      articles: [
        { title: "Navigation System", link: "#navigation" },
        { title: "Earnings Tracking", link: "#earnings" },
        { title: "Document Management", link: "#documents" },
      ],
    },
    {
