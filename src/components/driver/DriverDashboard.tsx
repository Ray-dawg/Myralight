...
export default function NavigationView() {
  ...
  const navItems = [
    ...
    { icon: Truck, label: "Truck", path: "/dashboard/truck" },
    ...
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="h-full relative">
            ...
            <div className="bg-white/95 backdrop-blur-sm shadow-lg rounded-xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
              ...
              <div className="flex flex-wrap items-center gap-4 w-full md:w-auto md:ml-auto">
                ...
                <div className="relative">
                  ...
                  {showNotifications && (
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border p-2">
          ...
          {/* Floating Cards - Moved to the yellow highlighted area */}
          <div className="absolute top-[8.5rem] md:top-32 left-4 md:left-28 right-4 md:right-auto md:w-96 space-y-4 pointer-events-auto">
            {showCards.trip && (
              <FloatingCard
                title="Current Trip"
                ...
                {!minimizedCards.nextStop && (
                  <div className="space-y-3">
                    ...
                    <div className="bg-blue-50 p-2 rounded-md text-xs border border-blue-200">
                      ...
                      <p className="text-blue-700">
                        This stop has 3 diesel pumps available now. Fuel prices
                        are $0.15/gal lower than the next stop on your route.
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="absolute bottom-20 md:bottom-8 left-1/2 transform -translate-x-1/2 w-[90%] max-w-2xl pointer-events-auto">
            <div className="bg-white/95 backdrop-blur-sm shadow-lg rounded-xl p-4">
              ...
              {/* Filter buttons - highlighted in yellow in the screenshot */}
              <div className="flex gap-2 mt-3">
                ...
                <Popover
                  open={showRatePopover}
                  onOpenChange={setShowRatePopover}
                >
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                ...
                <Popover
                  open={showTimePopover}
                  onOpenChange={setShowTimePopover}
                >
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                ...
                <Popover
                  open={showTypePopover}
                  onOpenChange={setShowTypePopover}
                >
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
