...
import LoadCreationForm, { LoadFormData } from "../admin/LoadCreationForm";
import { useMutation } from "convex/react";
import { api } from "../../lib/convex/_generated/api";
import { useToast } from "@/components/ui/use-toast";
import { Id } from "../../lib/convex/_generated/dataModel";

export default function LoadCreationConvex() {
  ...
  return <LoadCreationForm isAdmin={false} onSubmit={handleSubmit} />;
}
